 ...
 * Version: 8.1.0-conflict-free
 * Clean deployment without merge conflicts
 * Force deploy: 2025-01-27T16:00:00.000Z
 */
...
app.get('/', (req, res) => {
  res.json({
    name: 'Railway OAuth Backend - Conflict-Free Version',
    version: '8.1.0-conflict-free',
    status: 'operational',
    ...
    debug: 'OAuth backend without merge conflicts',
    timestamp: new Date().toISOString(),
    uptime: process.uptime()
  });
});
